...
def _index(req,
    ...
    if settings.ENABLE_DR11:
        ...
        tile_layers.update({
            ...
            'ls-dr11-model': ['Legacy Surveys DR11 models', [def_url], maxnative11mr, 'ls'],
            'ls-dr11-resid': ['Legacy Surveys DR11 residuals', [def_url], maxnative11mr, 'ls'],
            # Boundary-row ("mid") tiles for the combined N+S layers: proper
            # composite renders for the dec-masked --top zooms (z0-7); at z8+
            ...
            'ls-dr11-mid-model': ['Legacy Surveys DR11 models',
                             [[0, 7, 'https://s3.us-west-2.amazonaws.com/dr11-south-model.legacysurvey.org/mid/{z}/{x}/{y}.jpg', []],
                              [8, 12, 'https://s3.us-west-2.amazonaws.com/dr11-south-model.legacysurvey.org/{z}/{x}/{y}.jpg', []],
                              def_url], maxnative11mr, 'ls'],
            'ls-dr11-mid-resid': ['Legacy Surveys DR11 residuals',
                             [[0, 7, 'https://s3.us-west-2.amazonaws.com/dr11-south-resid.legacysurvey.org/mid/{z}/{x}/{y}.jpg', []],
            ...
            'ls-dr11-north-resid': ['Legacy Surveys DR11-north residuals',
                             [[0, 12, 'https://s3.us-west-2.amazonaws.com/dr11-north-resid.legacysurvey.org/{z}/{x}/{y}.jpg', []],
                              def_url], maxnative11mr, 'ls'],
        })
    ...
    if settings.ENABLE_DR9:
        tile_layers.update({
            ...
            'ls-dr9-mid': ['Legacy Surveys DR9 images',
                             [[0, 5, 'https://s3.us-west-2.amazonaws.com/dr11-south.legacysurvey.org/mid-dr9/{z}/{x}/{y}.jpg', []],
                              [6, 14, 'https://s3.us-west-2.amazonaws.com/dr9-south.legacysurvey.org/{z}/{x}/{y}.jpg', []],
                              def_url], maxnative, 'ls'],
    ...
    kwkeys = dict(
        ...
        enable_desi_edr_spectra = settings.ENABLE_DESI_EDR_SPECTRA,
        enable_desi_dr1_spectra = settings.ENABLE_DESI_DR1_SPECTRA,
