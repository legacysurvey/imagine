...
class Router(object):
    def db_for_read(self, model, **hints):
        #print('db_for_read: models', model, 'hints', hints)

        #models', <class 'cat.models_dr2.DR2_Target'>, u'hints', {}
        if model is DR2_Target:
            #print('DR2_Target -> dr2 db')
            return 'dr2'
...
# DR2 database introspection:
# on sgn04:
#   cd ~/cosmo/webapp/viewer-dev
#   source ./viewer-dev-conda/bin/activate viewer-dev-conda
