...
#         managed = False
#         db_table = 'candidate'
# # Unable to inspect table 'celeste10k'
# # The error was: permission denied for relation celeste10k
# 
# 
# 
...
#     id = models.BigAutoField(primary_key=True)
#     cand = models.ForeignKey('DecamCand', models.DO_NOTHING, blank=True, null=True)
...
#         managed = False
#         db_table = 'decam_aper'
# # Unable to inspect table 'dr1todr2'
# # The error was: permission denied for relation dr1todr2
# 
# 
# 
